...
class TestDateModel:
    ...
    def test_date_gmt_obj_successfully_converts_into_unix_timestamp_without_specifying_any_data(self):
        """
    ...
    def test_date_gmt_obj_successfully_converts_into_unix_timestamp_in_other_time_format(self):
        """
        GIVEN a not inputed data (uses default value from the system)
        WHEN converts the inputed date into unix format
        ...
        assert date_obj.get_unix_timestamp * 1000000 == assert_data * 1000000 # microseconds
        assert date_obj.get_unix_timestamp * 1000000000 == assert_data * 1000000000 # nanoseconds
    ...
    def test_date_dict_serialized_as_JSON(self):
        ...
        """
        expected_json = """{"unix": 1673913600, "utc": "Tue, 17 Jan 2023 00:00:00 GMT"}"""
    ...
    def test_receive_timestamp_then_call_fuction_formated_data_and_function_get_unix_timestamp_and_returns_None(self):
        """
        ...
        """
        date_obj = DateModel('1673913600000000000')
        assert date_obj.get_formated_data == None
        assert date_obj.get_unix_timestamp == None

    def test_receive_date_then_call_fuction_get_date_from_timestamp_and_function_and_returns_None(self):
        """
        ...
        """
        date_obj = DateModel('2023-01-17')
        assert date_obj.get_date_from_timestamp == None
